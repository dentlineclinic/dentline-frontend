...
export default function AdminRequestOtpPage() {
  ...
  const mutation = useRequestAdminOtp();
          ...
          <div className="hidden md:flex flex-col justify-between bg-[#008375] p-10 w-[420px] flex-shrink-0">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-white/80 text-lg leading-relaxed">
                Secure OTP-based authentication for authorised administrators only.
              </p>
            </div>
          ...
          <div className="flex-1 flex flex-col justify-center px-10 md:px-16 py-16">
            ...
            <div className="flex items-center gap-2 mb-8">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-semibold text-[#00685C]">Request OTP</span>
              </div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs font-semibold text-[#94A3B8]">Verify & Login</span>
              </div>
            </div>
